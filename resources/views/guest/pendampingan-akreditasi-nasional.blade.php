<x-layout.page title="Pendampingan Akreditasi Nasional" background="assets/img/default.jpg" class="pendampingan-akreditasi-nasional">
    
    {{-- List --}}
    <div class="pendampingan-akreditasi-nasional__list">
