        ...
        @foreach ($peraturan_rektors as $peraturan_rektor)
            <div class="list__item">
                ...
                <div class="item__right">
                    <x-button type="link" href="{{ route('guest.peraturan-rektor.download', compact('peraturan_rektor')) }}" class="button__outline item__download"><i class="fa-solid fa-download"></i>Download</x-button>
