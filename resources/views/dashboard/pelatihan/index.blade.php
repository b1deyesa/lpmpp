                    ...
                    @foreach ($pelatihans as $pelatihan)
                        ...
                        <div class="list__item" x-show="search === '' || '{{ $searchable }}'.includes(search.toLowerCase())">
                            ...
                            <div class="item__right">
                                ...
                                <x-button type="link" href="{{ route('dashboard.pelatihan.show', compact('pelatihan')) }}" class="button__link"><i class="fa-solid fa-arrow-up-right-from-square"></i>Visit</x-button>
                            </div>
                        </div>
                    @endforeach
                </section>
